...
confirm_button = Button(root, text="Confirm", command=confirm, width=15, height=2)
confirm_button.grid(row=2, column=0, sticky='se')

clear_button = Button(root, text="Clear All", command=clear, width=15, height=2)
...
dbresult_label = Label(root, text="")
...
def update_result():
    ...
    root.after(next_minute, update_result)
